                    ...
                    <div class="card-body">
                        ...
                        <nav>
                            <ul class="pagination">
                                ...
                                <li class="page-item">
                                    <a class="page-link" href="#" v-if="pagination.current_page < pagination.last_page" @click.prevent="cambiarPagina(pagination.current_page + 1, buscar, criterio)">Sig</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row border">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Precio</label>
                                    <input type="number" class="form-control" v-model="precio" step="any" value="0">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>Cantidad</label>
                                    <input type="number" class="form-control" v-model="cantidad" step="any" value="0">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
        ...
        methods : {
          ...
          registrarPersona(){
            ...
            let me = this;
              ...
              .catch(function (error){
                console.log(error+" Se ejecuto un error");    
              })
          },
          actualizarPersona(){
              if(this.validarPersona()){
          ...
          validarPersona(){
              ...
              if (!this.password) this.errorMostrarMsjPersona.push("El passowrd no puede estar vacío.");
